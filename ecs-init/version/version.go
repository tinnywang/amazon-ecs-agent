...
import ecsversion "github.com/aws/amazon-ecs-agent/ecs-version"

// Version is the version of the ecs-init
const Version string = ecsversion.Version

// GitDirty indicates the cleanliness of the git repo when this ecs-init was built
const GitDirty bool = ecsversion.GitDirty

// GitShortHash is the short hash of this ecs-init build
const GitShortHash string = ecsversion.GitShortHash
