...
const versionTemplate = `// This is an autogenerated file and should not be edited.
...
func releaseCommitGitHash() (string, error) {
	fullHash, err := os.ReadFile("RELEASE_COMMIT")
	if err != nil {
...
// cleanliness.
//
// Usage: go run ecs-version/gen/version-gen.go
func main() {
	...
	outFile, err := os.Create("ecs-version/version.go")
	if err != nil {
